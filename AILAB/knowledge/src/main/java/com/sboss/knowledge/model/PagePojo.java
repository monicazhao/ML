 ...
 * @author wenjie
 */
public class PagePojo extends AbstractEntity {
	
	/**
	 * 日志
	 */
	private static final Log LOGGER = LogFactory.getLog(PagePojo.class);
    ...
    public String toString() {
		...
		if (!getResults().isEmpty()) {
			try {
				...
				PagePojo.LOGGER.warn("转换过程出现问题，请根据警告信息进行检查", e);
				return rts;
			}

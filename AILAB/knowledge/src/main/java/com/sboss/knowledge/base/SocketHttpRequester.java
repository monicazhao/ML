...
public class SocketHttpRequester {
     ...
     * @param file 上传文件
     */
    public static boolean post(String path, Map<String, String> params, FormFile[] files,HashMap<String, String> urlmap) throws Exception{     
        ...
        while ((strline=reader.readLine())!=null){
        	...
        	if(strline.indexOf("puburl:")>=0){
        		...
        		//System.out.println("puburl11111:"+puburl);
        	}
        }
     ...
     * @param file 上传文件
     */
    public static boolean post(String path, Map<String, String> params, FormFile file, HashMap<String, String> urlmap) throws Exception{
    	//this.puburl=puburl;
    	return post(path, params, new FormFile[]{file}, urlmap);
    }
